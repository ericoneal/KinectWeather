...
namespace Microsoft.Samples.Kinect.GreenScreen
{
    ...
    {   
        ...
        List<ImageSource> lstImages = new List<ImageSource>();
        Image img;
        BitmapImage bmp;
        int imgIndex = 1;
        /// <summary>
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            bmp = new BitmapImage();
            bmp.BeginInit();
            bmp.UriSource = new Uri("pack://application:,,,/GreenScreen-WPF;component/Images/temps.jpg");
            bmp.EndInit();
            img.Source = bmp;
            lstImages.Add(bmp);
            ...
            bmp = new BitmapImage();
            bmp.BeginInit();
            bmp.UriSource = new Uri("pack://application:,,,/GreenScreen-WPF;component/Images/precip.jpg");
            bmp.EndInit();
            img.Source = bmp;
            lstImages.Add(bmp);
            ...
            bmp = new BitmapImage();
            bmp.BeginInit();
            bmp.UriSource = new Uri("pack://application:,,,/GreenScreen-WPF;component/Images/tornadoalley.jpg");
            bmp.EndInit();
            img.Source = bmp;
            lstImages.Add(bmp);
            ...
            bmp = new BitmapImage();
            bmp.BeginInit();
            bmp.UriSource = new Uri("pack://application:,,,/GreenScreen-WPF;component/Images/ef.jpg");
            bmp.EndInit();
            img.Source = bmp;
            lstImages.Add(bmp);
        ...
        private void Window_MouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            else
            {
                ...
                Backdrop.Source = lstImages[imgIndex];
                imgIndex++;
            }
        }
